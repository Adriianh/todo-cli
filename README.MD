...
```bash
java -jar /bin/todo.jar add "Plan trip" --description "Book flight, Find hotel, Pack bags"
```
...
```bash
java -jar /bin/todo.jar set-path "project_a.json"
```
